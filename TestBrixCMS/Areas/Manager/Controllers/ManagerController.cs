...
public class ManagerController : Controller
{
    ...
    public async Task<IActionResult> SavePageSettings(Guid pageId, string backgroundColor, string fontFamily = "", string metaDescription = "", string ogImage = "", string pageTitle = "")
    {
        ...
        var settings = new TestBrixCMS.Models.Pages.StandardPage
        {
            BackgroundColor = new TestBrixCMS.Data.Fields.ColorField { Value = backgroundColor },
            FontFamily      = new TestBrixCMS.Data.Fields.StringField { Value = fontFamily },
        };
