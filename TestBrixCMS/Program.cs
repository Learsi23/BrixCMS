...
using TestBrixCMS.Services.Email;
using TestBrixCMS.Services.Ingestion;
...
builder.Services.AddSession(options =>
{
    ...
    options.Cookie.Name = ".TestBrixCMS.Session";
...
app.MapRazorComponents<TestBrixCMS.Components.App>()
...
using (var scope = app.Services.CreateScope())
{
    ...
    TestBrixCMS.Services.BrixLandingSeeder.SeedIfEmpty(db);
    ...
    {
        var hash = TestBrixCMS.Services.AdminAuthService.HashPassword("admin123", out var salt);
        db.AdminUsers.Add(new TestBrixCMS.Data.AdminUser
        {
