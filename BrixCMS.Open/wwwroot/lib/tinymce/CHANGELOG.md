...
- Fixed the order of CSS precbrixce of `content_style` and `content_css` in the `preview` and `template` plugins. `content_style` now has precbrixce. #TINY-6529
...
### Added
- Added a new imagetools_crbrixtials_hosts option to the Imagetools Plugin.
